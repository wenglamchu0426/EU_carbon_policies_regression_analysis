...
**(4) FINDINGS**<br>
The regression analysis showed that the three interaction terms between EU membership and PolSt, RoL, and VaA are statistically significant, while the main coefficient (β1) is not. This indicates that the effect of EU membership on carbon emissions may be moderated by the type/quality of governance in the country, but membership itself does not have a signiticant correlation with lower emissions. 
